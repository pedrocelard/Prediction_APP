...
# FULL_SAMPLE_FLAGS="--cond_frames 0, --seq_len 15 --batch_size 1 --num_samples 69"; 


# # 1-Generate 15 frames from start to finish
# echo "Generating Overview samples"
# python video_sample.py --data_dir $FULL_DATA_PATH --model_path $FULL_MODEL_PATH --batch_size 1 $FULL_MODEL_FLAGS $FULL_DIFFUSION_FLAGS $FULL_SAMPLE_FLAGS
...
PARTIAL_DATA_PATH="best_cases/multiple_final_samples/";
