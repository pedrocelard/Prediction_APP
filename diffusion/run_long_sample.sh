...
FULL_DATA_PATH="../../../Datasets/Embryo/EmbryoF1_20frames_128_gif/test/";
# FULL_MODEL_PATH="./log/EMBRYO_FULLLENGTH_MODEL_openai-2023-06-10-11-14-55-761094/ema_0.9999_200000.pt";
FULL_MODEL_PATH="./log/EMBRYO_PARTIAL_MODEL/ema_0.9999_300000.pt";
...
FULL_SAMPLE_FLAGS="--cond_frames 0, --seq_len 197 --batch_size 1 --num_samples 69 --resample_steps 1"; 


# 1-Generate 15 frames from start to finish
echo "Generating Long samples"
python long_sampling.py --data_dir $FULL_DATA_PATH --model_path $FULL_MODEL_PATH --batch_size 1 $FULL_MODEL_FLAGS $FULL_DIFFUSION_FLAGS $FULL_SAMPLE_FLAGS
